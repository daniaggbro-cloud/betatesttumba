...
UI.CreateToggleWithSettings(TabFrame, "toggle_kit_esp", "KitESP.Enabled", function(state)
    ...
    UI.CreateToggle(nil, "toggle_kit_stella", "KitESP.Filters.Stella"),
    UI.CreateToggle(nil, "toggle_kit_eldertree", "KitESP.Filters.Eldertree"),
    UI.CreateToggle(nil, "toggle_kit_lucia", "KitESP.Filters.Lucia"),
    UI.CreateToggle(nil, "toggle_kit_cletus", "KitESP.Filters.Cletus"),
    UI.CreateToggle(nil, "toggle_kit_deathadder", "KitESP.Filters.DeathAdder"),
    UI.CreateToggle(nil, "toggle_kit_sheepherder", "KitESP.Filters.SheepHerder"),
