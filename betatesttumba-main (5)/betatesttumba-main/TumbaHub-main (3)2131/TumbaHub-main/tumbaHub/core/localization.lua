...
Mega.Localization = {
    ...
    Strings = {
        ...
        -- Kit ESP Filters
        ["toggle_kit_stella"] = { ru = "Звезды Stella", en = "Stella Stars", uk = "Зірки Stella" },
        ["toggle_kit_eldertree"] = { ru = "Сферы Eldertree", en = "Eldertree Orbs", uk = "Сфери Eldertree" },
        ["toggle_kit_lucia"] = { ru = "Пиньята Lucia", en = "Lucia Piñata", uk = "Піньята Lucia" },
        ["toggle_kit_cletus"] = { ru = "Урожай Cletus", en = "Cletus Crops", uk = "Врожай Cletus" },
        ["toggle_kit_deathadder"] = { ru = "Кристаллы Adder", en = "Death Adder Crystals", uk = "Кристали Adder" },
        ["toggle_kit_sheepherder"] = { ru = "Овечки Sheep", en = "Sheep Herder", uk = "Овечки Sheep" },

        ["toggle_alchemist"] = { ru = "Алхимик (Alchemist)", en = "Alchemist", es = "Alquimista", pt = "Alquimista", ko = "연금술사", ja = "錬金術師", uk = "Алхімік" },
        ["toggle_alchemist_collect"] = { ru = "Авто-сбор ингредиентов", en = "Auto Collect Ingredients", es = "Recolección Auto", pt = "Coleta Auto", ko = "자동 재료 수집", ja = "材料自動収集", uk = "Авто-збір інгредієнтів" },
        ...
        ["slider_alchemist_range"] = { ru = "Дистанция сбора", en = "Collect Range", es = "Rango de Recolección", pt = "Alcance de Coleta", ko = "수집 범위", ja = "収集範囲", uk = "Дистанція збору" },
        ["slider_alchemist_esp_transparency"] = { ru = "Прозрачность ESP", en = "ESP Transparency", es = "Transparencia ESP", pt = "Transparência ESP", ko = "ESP 투명도", ja = "ESP透明度", uk = "Прозорість ESP" },
        ["toggle_lucia"] = { ru = "Люсия (Lucia)", en = "Lucia", es = "Lucia", pt = "Lucia", ko = "루시아", ja = "ルシア", uk = "Люсія" },
        ["toggle_lucia_autodeposit"] = { ru = "Авто-склад в Пиньяту", en = "Auto Deposit Piñata", es = "Depósito Auto Piñata", pt = "Depósito Auto Piñata", ko = "자동 피냐타 보관", ja = "ピニャータ自動保管", uk = "Авто-склад у Піньяту" },
        ["toggle_lucia_legit"] = { ru = "Легитный метод (Proximity)", en = "Legit Method", es = "Método Legítimo", pt = "Método Legítimo", ko = "합법적인 방법", ja = "合法的な方法", uk = "Легітний метод" },
        ["toggle_lucia_esp"] = { ru = "Подсветка Пиньят", en = "Piñata ESP", es = "ESP de Piñata", pt = "ESP de Piñata", ko = "피냐타 ESP", ja = "ピニャータESP", uk = "Підсвічування Піньят" },
        ["slider_lucia_range"] = { ru = "Дистанция склада", en = "Deposit Range", es = "Rango de Depósito", pt = "Alcance do Depósito", ko = "보관 범위", ja = "保管範囲", uk = "Дистанція складу" },
        ...
        ["slider_adetunde_range"] = { ru = "Радиус удара", en = "Hit Range", es = "Rango de Golpe", pt = "Alcance do Golpe", ko = "타격 범위", ja = "ヒット範囲", uk = "Радиус удару" },
        ...
        ["toggle_killaura_autoclick"] = { ru = "Легит Авто-Клик (ЛКМ)", en = "Legit Auto-Click (LMB)", es = "Auto Clic Legit", pt = "Auto Clique Legit", ko = "자동 클릭 (Legit)", ja = "オートクリック (Legit)", uk = "Легіт Авто-Клік (ЛКМ)" },
        ["slider_killaura_autoclick_cps"] = { ru = "Клики в секунду (CPS)", en = "Clicks per second (CPS)", es = "Clics por segundo (CPS)", pt = "Cliques por segundo (CPS)", ko = "초당 클릭 수 (CPS)", ja = "秒間クリック数 (CPS)", uk = "Кліки на секунду (CPS)" },
        ...
        ["update_text_v5_1"] = { ru = "• ДОБАВЛЕНА ЛЮСИЯ (LUCIA)\n• ДОБАВЛЕН АЛХИМИК (ALCHEMIST)\n• ИСПРАВЛЕНА KILLAURA + НОВЫЕ LEGIT ФУНКЦИИ\n• ДОБАВЛЕН AI ЧАТ\n• И МНОГОЕ ДРУГОЕ", en = "• ADDED LUCIA\n• ADDED ALCHEMIST\n• FIXED KILLAURA + NEW LEGIT KILLAURA FUNCTIONS\n• ADDED AI CHAT\n• AND MORE", es = "• AÑADIDA LUCIA\n• AÑADIDO ALQUIMISTA\n• KILLAURA ARREGLADA + NUEVAS FUNCIONES LEGIT\n• AÑADIDO CHAT IA\n• Y MUCHO MÁS", pt = "• ADICIONADA LUCIA\n• ADICIONADO ALQUIMISTA\n• KILLAURA CORRIGIDA + NOVAS FUNÇÕES LEGIT\n• ADICIONADO CHAT IA\n• E MUITO MAIS", ko = "• 루시아 추가\n• 연금술사 추가\n• 킬라우라 수정 및 새로운 합법 기능\n• AI 채팅 추가\n• 기타 등등", ja = "• ルシア追加\n• 錬金術師追加\n• キルオーラ修正および新しい合法機能\n• AIチャット追加\n• その他", uk = "• ДОДАНО ЛЮСІЮ\n• ДОДАНО АЛХІМІКА\n• ВИПРАВЛЕНО KILLAURA + НОВІ LEGIT ФУНКЦІЇ\n• ДОДАНО AI ЧАТ\n• ТА ІНШЕ" },
