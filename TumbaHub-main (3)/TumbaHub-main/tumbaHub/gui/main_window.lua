...
function Mega.UpdateStatus()
    ...
    -- Dynamically add active features
    ...
    if States.Player and States.Player.SpectateTarget then 
        AddStatus(Mega.GetText("spectating") or "Spectating", Color3.fromRGB(255, 255, 255)) 
    end
end
