...
UI.CreateToggleWithSettings(TabFrame, "toggle_killaura", "Combat.Killaura.Enabled", function(state)
    ...
    UI.CreateSlider(nil, "slider_killaura_animation_speed", "Combat.Killaura.AnimationSpeed", 1, 100, function(val) Mega.States.Combat.Killaura.AnimationSpeed = val / 10 end),
