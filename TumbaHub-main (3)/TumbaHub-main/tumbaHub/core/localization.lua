...
Mega.Localization = {
    ...
    Strings = {
        ...
        ["toggle_swim"] = { ru = "Плавание в воздухе", en = "Swim", uk = "Плавання в повітрі" },
        ...
        ["user_status_beloved"] = { ru = "❤️ Любимый пользователь", en = "❤️ Beloved User", es = "❤️ Usuario Querido", pt = "❤️ Usuário Querido", ko = "❤️ 사랑하는 사용자", ja = "❤️ 愛するユーザー", uk = "❤️ Улюблений користувач" },
        ...
        ["notify_keybind_removed"] = { ru = "Бинд для %s удален", en = "Keybind for %s removed", es = "Keybind para %s eliminado", pt = "Keybind para %s removido", ko = "%s 키바인드 제거됨", ja = "%s のキーバインドが解除されました", uk = "Бінд для %s видалено" },
        ...
        ["toggle_streamproof_mode"] = { ru = "🎥 Режим Записи (Скрыть чит)", en = "🎥 Recording Mode (Hide Cheat)", es = "🎥 Modo de Grabación (Ocultar Cheat)", pt = "🎥 Modo de Gravação (Ocultar Cheat)", ko = "🎥 녹화 모드 (치트 숨기기)", ja = "🎥 録画モード (チート非表示)", uk = "🎥 Режим Запису (Приховати чіт)" },
        ["notify_streamproof_started"] = { ru = "🎥 Режим записи! Чит скрыт. Нажми RightShift чтобы вернуть.", en = "🎥 Recording mode! Cheat hidden. Press RightShift to restore.", es = "🎥 ¡Modo grabación! Cheat oculto. Presiona RightShift para restaurar.", pt = "🎥 Modo gravação! Cheat oculto. Pressione RightShift para restaurar.", ko = "🎥 녹화 모드! 치트 숨김. RightShift를 눌러 복구.", ja = "🎥 録画モード！チート非表示。RightShiftで復元。", uk = "🎥 Режим запису! Чіт приховано. Натисни RightShift щоб повернути." },
        ["notify_streamproof_stopped"] = { ru = "✅ Режим записи выключен.", en = "✅ Recording mode disabled.", es = "✅ Modo de grabación desactivado.", pt = "✅ Modo de gravação desativado.", ko = "✅ 녹화 모드 비활성화됨.", ja = "✅ 録画モード無効化。", uk = "✅ Режим запису вимкнено." },
        ...
        ["slider_cletus_autobuyspeed"] = { ru = "Скорость покупки (сек)", en = "Buy Speed (sec)", es = "Velocidad de Compra", pt = "Velocidade de Compra", ko = "구매 속도 (초)", ja = "購入速度 (秒)", uk = "Швидкість покупки (сек)" },
        ["slider_cletus_maxamount"] = { ru = "Макс. кол-во семян", en = "Max Seed Amount", es = "Cantidad Máxima", pt = "Quantidade Máxima", ko = "최대 씨앗 개수", ja = "最大種数", uk = "Макс. кількість насіння" },
        ...
        ["toggle_taliyah"] = { ru = "Талия (Taliyah)", en = "Taliyah", es = "Taliyah", pt = "Taliyah", ko = "탈리야", ja = "タリヤ", uk = "Талія" },
        ["toggle_taliyah_esp"] = { ru = "Подсветка куриц", en = "Chicken ESP", es = "ESP de Pollos", pt = "ESP de Galinhas", ko = "닭 ESP", ja = "鶏ESP", uk = "Підсвічування курей" },
        ["toggle_taliyah_collect"] = { ru = "Авто-сбор куриц", en = "Auto Chickens", es = "Recolección Auto", pt = "Coleta Auto", ko = "자동 닭 수집", ja = "自動鶏収集", uk = "Авто-збір курей" },
        ["toggle_taliyah_collect_legit"] = { ru = "Авто-сбор куриц (Legit)", en = "Auto Chickens (legit)", es = "Recolección Auto (Legit)", pt = "Coleta Auto (Legit)", ko = "자동 닭 수집 (Legit)", ja = "自動鶏収集 (Legit)", uk = "Авто-збір курей (Legit)" },
        ["slider_taliyah_radius"] = { ru = "Радиус сбора", en = "Collect Radius", es = "Radio de Recolección", pt = "Raio de Coleta", ko = "수집 반경", ja = "収集半径", uk = "Радіус збору" },
        ["slider_taliyah_esp_transparency"] = { ru = "Прозрачность ESP", en = "ESP Transparency", es = "Transparencia ESP", pt = "Transparência ESP", ko = "ESP 투명도", ja = "ESP透明度", uk = "Прозорість ESP" },
        ...
        ["toggle_adetunde"] = { ru = "Адетунде Aura (⚠️ Может повысить пинг, отключайте!)", en = "Adetunde Aura (⚠️ May spike ping, turn off!)", es = "Aura Adetunde (⚠️ Puede subir el ping)", pt = "Aura Adetunde (⚠️ Pode aumentar o ping)", ko = "아데툰데 Aura (⚠️ 핑 상승 주의)", ja = "アデトゥンデ Aura (⚠️ Ping上昇注意)", uk = "Адетунде Aura (⚠️ Може підвищити пінг!)" },
        ["toggle_adetunde_target_esp"] = { ru = "Показывать цель", en = "Show Target ESP", es = "Mostrar Objetivo", pt = "Mostrar Alvo", ko = "대상 ESP 표시", ja = "ターゲットESPを表示", uk = "Показувати ціль" },
        ["slider_adetunde_delay"] = { ru = "Задержка (мс)", en = "Delay (ms)", es = "Retraso (ms)", pt = "Atraso (ms)", ko = "지연 (ms)", ja = "遅延 (ms)", uk = "Затримка (мс)" },
        ["section_combat_autobuy"] = { ru = "🛒 АВТО-ЗАКУПКА (В ТЕХ. РАБОТАХ)", en = "🛒 AUTOBUY (MAINTENANCE)", es = "🛒 AUTO-COMPRA (PROXIMAMENTE)", pt = "🛒 AUTO-COMPRA (EM BREVE)", ko = "🛒 자동 구매 (준비 중)", ja = "🛒 オートバイ (準備中)", uk = "🛒 АВТО-ЗАКУПКА (ТЕХ. РОБОТИ)" },
        ["coming_soon"] = { ru = "Функция временно отключена для оптимизации. Скоро вернем!", en = "Feature temporarily disabled for optimization. Coming back soon!", es = "Función desactivada temporalmente. ¡Próximamente de nuevo!", pt = "Função temporariamente desativada. Em breve!", ko = "최적화를 위해 기능을 일시적으로 비활성화했습니다. 곧 다시 출시될 예정입니다!", ja = "最適化のため一時的に無効になっています。近日公開予定です！", uk = "Функція тимчасово відключена для оптимізації. Скоро повернемо!" },
        ["slider_adetunde_range"] = { ru = "Дистанция", en = "Range", es = "Rango", pt = "Alcance", ko = "범위", ja = "範囲", uk = "Дистанція" },
        ["section_combat_killaura"] = { ru = "KILLAURA", en = "KILLAURA", es = "KILLAURA", pt = "KILLAURA", ko = "킬라우라", ja = "キルオーラ", uk = "KILLAURA" },
        ...
        ["toggle_killaura_animation"] = { ru = "🎬 Анимация ударов", en = "🎬 Attack Animation", uk = "🎬 Анімація ударів" },
        ["dropdown_killaura_animation_mode"] = { ru = "Тип анимации", en = "Animation Type", uk = "Тип анімації" },
        ["slider_killaura_animation_speed"] = { ru = "Скорость анимации", en = "Animation Speed", uk = "Швидкість анімації" },
        ...
        ["slider_bednuke_break_speed"] = { ru = "Скорость ломания", en = "Break Speed", uk = "Швидкість ламання" },
        ["slider_bednuke_update_rate"] = { ru = "Частота обновлений", en = "Update Rate", uk = "Частота оновлень" },
        ["toggle_bednuke_break_bed"] = { ru = "Ломать Кровати", en = "Break Bed", uk = "Ламати Ліжка" },
        ["toggle_bednuke_break_tesla"] = { ru = "Ломать Теслы", en = "Break Tesla", uk = "Ламати Тесли" },
        ["toggle_bednuke_break_hive"] = { ru = "Ломать Ульи", en = "Break Hive", uk = "Ламати Вулики" },
        ["toggle_bednuke_break_lucky"] = { ru = "Ломать Лаки Блоки", en = "Break Lucky Block", uk = "Ламати Лакі Блоки" },
        ["toggle_bednuke_break_iron"] = { ru = "Ломать Железную Руду", en = "Break Iron Ore", uk = "Ламати Залізну Руду" },
        ["toggle_bednuke_self_break"] = { ru = "Ломать свои постройки", en = "Self Break", uk = "Ламати власні споруди" },
        ["toggle_bednuke_instant"] = { ru = "Мгновенное ломание", en = "Instant Break", uk = "Миттєве ламання" },
        ["dropdown_bednuke_sorting"] = { ru = "Сортировка", en = "Break Sorting", uk = "Сортування" },
        ...
        ["toggle_speed_autojump"] = { ru = "Авто-прыжок (AutoJump)", en = "Auto Jump", uk = "Авто-стрибок" },
        ...
        ["toggle_wall_hop"] = { ru = "Авто Wall Hop", en = "Auto Wall Hop", uk = "Авто Wall Hop" },
        ...
        ["toggle_wall_hop_stabilize"] = { ru = "Стабилизация камеры (Без тряски)", en = "Camera Stabilization (No Shake)", uk = "Стабілізація камери (Без тряски)" },
        ["toggle_bed_defend"] = { ru = "Авто-Защита кровати (Bed Defend)", en = "Auto Bed Defend", uk = "Авто-Захист ліжка (Bed Defend)" },
        ["dropdown_bed_defend_block"] = { ru = "Тип блока", en = "Block Type", uk = "Тип блоку" },
        ["slider_bed_defend_layer"] = { ru = "Слои защиты", en = "Defense Layers", uk = "Шари захисту" },
        ...
        ["toggle_alchemist"] = { ru = "Алхимик (Alchemist)", en = "Alchemist", es = "Alquimista", pt = "Alquimista", ko = "연금술사", ja = "錬金術師", uk = "Алхімік" },
        ["toggle_alchemist_esp"] = { ru = "Подсветка ингредиентов", en = "Ingredient ESP", es = "ESP de Ingredientes", pt = "ESP de Ingredientes", ko = "재료 ESP", ja = "材料ESP", uk = "Підсвічування інгредієнтів" },
        ["toggle_alchemist_autocollect"] = { ru = "Авто-сбор", en = "Auto-Collect", es = "Auto-Recolectar", pt = "Auto-Coletar", ko = "자동 수집", ja = "自動収集", uk = "Авто-збір" },
        ...
        ["toggle_autobuy_armor"] = { ru = "Авто-Броня", en = "Auto Armor", es = "Auto Armadura", pt = "Auto Armadura", ko = "자동 방어구", ja = "オートアーマー", uk = "Авто-Броня" },
        ["toggle_autobuy_swords"] = { ru = "Авто-Мечи", en = "Auto Swords", es = "Auto Espadas", pt = "Auto Espadas", ko = "자동 검", ja = "オートソード", uk = "Авто-Мечі" },
        ["toggle_autobuy_tools"] = { ru = "Авто-Инструменты", en = "Auto Tools", es = "Auto Herramientas", pt = "Auto Ferramentas", ko = "자동 도구", ja = "オートツール", uk = "Авто-Інструменти" },
        ["toggle_autobuy_wool"] = { ru = "Авто-Шерсть (Блоки)", en = "Auto Wool (Blocks)", es = "Auto Lana", pt = "Auto Lã", ko = "자동 양털", ja = "オートウール", uk = "Авто-Вовна (Блоки)" },
        ["toggle_autobuy_arrows"] = { ru = "Авто-Стрелы", en = "Auto Arrows", es = "Auto Flechas", pt = "Auto Flechas", ko = "자동 화살", ja = "オートアロー", uk = "Авто-Стріли" },
        ["coming_soon"] = { ru = "Скоро...", en = "Coming Soon...", es = "Próximamente...", pt = "Em breve...", ko = "곧 출시...", ja = "近日公開...", uk = "Скоро..." },
        ["toggle_trap_disabler"] = { ru = "Trap Disabler (Обход капканов)", en = "Trap Disabler", uk = "Trap Disabler (Обхід капканів)" },
        ["tooltip_trap_disabler"] = { ru = "Автоматический обход и отключение вражеских капканов", en = "Automatically bypass and disable enemy traps", uk = "Автоматичний обхід та відключення ворожих капканів" },
        ["toggle_trap_esp"] = { ru = "Trapper ESP (Подсветка капканов)", en = "Trap ESP", uk = "Trapper ESP (Підсвічування капканів)" },
        ...
        ["textbox_staff_detector_role"] = { ru = "Мин. ранг", en = "Min Rank", uk = "Мін. ранг" },
        ["textbox_staff_detector_profile"] = { ru = "Профиль", en = "Profile", uk = "Профіль" },
        ["textbox_staff_detector_users"] = { ru = "ЧС Игроков", en = "Blacklisted Users", uk = "ЧС Гравців" },
        ["tooltip_trap_esp"] = { ru = "Подсвечивает расставленные вражеские капканы", en = "Highlights placed enemy snap traps", uk = "Підсвічує розставлені ворожі капкани" },
        ["toggle_bed_plates"] = { ru = "Пластины кроватей (Bed Plates)", en = "Bed Plates", uk = "Пластини ліжок (Bed Plates)" },
        ["tooltip_bed_plates"] = { ru = "Отображает слои блоков защиты над кроватями", en = "Displays block defense layers above beds", uk = "Відображає шари блоків захисту над ліжками" },
        ["toggle_bed_plates_background"] = { ru = "Задний фон пластин", en = "Plates Background", uk = "Задній фон пластин" },
        ["toggle_bed_plates_counter"] = { ru = "Счетчик слоев", en = "Layer Counter", uk = "Лічильник шарів" },
        ...
        ["tab_esp"] = { ru = "ESP", en = "ESP", es = "ESP", pt = "ESP", ko = "ESP", ja = "ESP", uk = "ESP" },
        ["tab_aim"] = { ru = "AIM", en = "AIM", es = "PUNTERÍA", pt = "MIRA", ko = "조준", ja = "狙い", uk = "AIM" },
        ["tab_player"] = { ru = "ИГРОК", en = "PLAYER", es = "JUGADOR", pt = "JUGADOR", ko = "플레이어", ja = "プレイヤー", uk = "ГРАВЕЦЬ" },
        ...
        ["tab_users"] = { ru = "ИГРОКИ", en = "PLAYERS", es = "JUGADORES", pt = "JUGADORES", ko = "플레이어들", ja = "プレイヤー", uk = "ГРАВЦІ" },
        ["tab_utils"] = { ru = "УТИЛИТЫ", en = "UTILITIES", es = "UTILIDADES", pt = "UTILITÁRIOS", ko = "УТИЛІТИ", ja = "ユーティリティ", uk = "УТИЛІТИ" },
        ["tab_settings"] = { ru = "НАСТРОЙКИ", en = "SETTINGS", es = "AJUSTES", pt = "CONFIGURAÇÕES", ko = "설정", ja = "設定", uk = "НАЛАШТУВАННЯ" },
        ["tab_bot"] = { ru = "БОТ", en = "BOT", es = "BOT", pt = "BOT", ko = "봇", ja = "ボット", uk = "БОТ" },
        ["tab_ai_chat"] = { ru = "AI ЧАТ", en = "AI CHAT", es = "CHAT IA", pt = "CHAT IA", ko = "AI 채팅", ja = "AIチャット", uk = "AI ЧАТ" },
        ["section_bot_main"] = { ru = "ОСНОВНОЙ БОТ", en = "MAIN BOT", es = "BOT PRINCIPAL", pt = "BOT PRINCIPAL", ko = "메인 봇", ja = "メインボット", uk = "ОСНОВНОЙ БОТ" },
        ...
        ["section_bot_autoplay"] = { ru = "🤖 AUTO PLAY (LOBBY)", en = "🤖 AUTO PLAY (LOBBY)", es = "🤖 AUTO PLAY (LOBBY)", pt = "🤖 AUTO PLAY (LOBBY)", ko = "🤖 자동 시작 (로비)", ja = "🤖 自動開始 (ロビー)", uk = "🤖 AUTO PLAY (ЛОБІ)" },
        ["toggle_bot_autoplay"] = { ru = "Авто-вход в игру", en = "Auto-Join Game", es = "Auto-Unirse al Juego", pt = "Auto-Entrar no Jogo", ko = "자동 게임 참가", ja = "自動ゲーム参加", uk = "Авто-вхід у гру" },
        ["dropdown_bot_autoplay_mode"] = { ru = "Режим очереди", en = "Queue Mode", es = "Modo de Cola", pt = "Modo de Fila", ko = "대기열 모드", ja = "待機列モード", uk = "Режим черги" },
        ...
        ["label_bot_autolobby"] = { ru = "Авто-лобби (После игры)", en = "Auto-Lobby (After Match)", es = "Auto-Lobby (Después del Juego)", pt = "Auto-Lobby (Após Jogo)", ko = "자동 로비 (게임 종료 후)", ja = "自動ロビー (試合後)", uk = "Авто-лобі (Після гри)" },
        ["section_bot_resources"] = { ru = "💎 РЕСУРСЫ И МАГАЗИН", en = "💎 RESOURCES & SHOP", es = "💎 RECURSOS Y TIENDA", pt = "💎 RECURSOS E LOJA", ko = "💎 자원 및 상점", ja = "💎 リソースとショップ", uk = "💎 РЕСУРСИ ТА МАГАЗИН" },
        ["toggle_bot_autoshop"] = { ru = "Авто-закупка блоков", en = "Auto-Buy Blocks", es = "Auto-Compra de Bloques", pt = "Auto-Compra de Blocos", ko = "자동 블록 구매", ja = "自動ブロック購入", uk = "Авто-закупівля блоків" },
        ["slider_bot_target_iron"] = { ru = "Лимит железа для сбора", en = "Iron Collection Limit", es = "Límite de Hierro", pt = "Limite de Ferro", ko = "철 수집 제한", ja = "鉄の収集制限", uk = "Ліміт заліза для збору" },
        ["slider_bot_min_blocks"] = { ru = "Минимально блоков", en = "Min Blocks", es = "Mínimo de Bloques", pt = "Mínimo de Blocos", ko = "최소 블록", ja = "最小ブロック", uk = "Мінімально блоків" },
        ...
        ["section_status"] = { ru = "💎 СИСТЕМНЫЙ СТАТУС", en = "💎 SYSTEM STATUS", es = "💎 ESTADO DEL SISTEMA", pt = "📊 ESTATÍSTICAS DO SISTEMA", ko = "📊 시스템 통계", ja = "📊 システム統計", uk = "📊 СТАТИСТИКА СИСТЕМИ" },
        ...
        ["toggle_aimbot"] = { ru = "Включить Aimbot", en = "Enable Aimbot", es = "Habilitar Aimbot", pt = "Ativar Aimbot", ko = "에임봇 활성화", ja = "エイムボット有効", uk = "Увімкнути Aimbot" },
        ...
        ["toggle_aim_click"] = { ru = "Аим при клике (Click aim)", en = "Click aim", uk = "Аїм при кліку (Click aim)" },
        ["toggle_aim_mousedown"] = { ru = "Зажимать кнопку мыши", en = "Require mouse down", uk = "Затискати кнопку миші" },
        ["toggle_aim_strafe"] = { ru = "Увеличение при стрейфах", en = "Strafe increase", uk = "Збільшення при стрейфах" },
        ["toggle_aim_blockbreak"] = { ru = "Проверять ломание блоков", en = "Check block break", uk = "Перевіряти ламання блоків" },
        ["toggle_aim_killaura"] = { ru = "Использовать цель киллауры", en = "Use killaura target", uk = "Використовувати ціль кіллаури" },
        ...
        ["dropdown_aim_area_center"] = { ru = "Центр (Center)", en = "Center", uk = "Центр" },
        ["dropdown_aim_area_closest"] = { ru = "Ближайшая точка (Closest)", en = "Closest part", uk = "Найближча точка" },
        ...
        ["slider_chest_esp_range"] = { ru = "Макс. дистанция", en = "Max Distance", es = "Distancia Máxima", pt = "Alcance Máximo", ko = "최대 거리", ja = "最大距離", uk = "Макс. дистанція" },
        ...
        ["dropdown_base_theme"] = { ru = "Базовая тема", en = "Base Theme", es = "Tema base", pt = "Tema base", ko = "기본 테마", ja = "ベーステーマ", uk = "Базова тема" },
        ...
        ["language_korean"] = { ru = "한국어 (Корейский)", en = "Korean (한국어)", es = "Coreano (한국어)", pt = "Coreano (한국어)", ko = "한국어", ja = "Korean (일본어)", uk = "한국어 (Корейська)" },
        ...
        ["toggle_killaura_mobile_btn"] = { ru = "⚔️ Кнопка Killaura", en = "⚔️ Killaura Button", es = "⚔️ Botón Killaura", pt = "⚔️ Botão Killaura", ko = "⚔️ 킬라우라 버튼", ja = "⚔️ キルオーラボタン", uk = "⚔️ Кнопка Killaura" },
        ["toggle_aim_mobile_btn"] = { ru = "🎯 Кнопка Aim Assist", en = "🎯 Aim Assist Button", es = "🎯 Botón Aim Assist", pt = "🎯 Botão Aim Assist", ko = "🎯 에임 어시스트 버튼", ja = "🎯 エイムアシストボタン", uk = "🎯 Кнопка Aim Assist" },
        ["toggle_scaffold_mobile_btn"] = { ru = "🧱 Кнопка Scaffold", en = "🧱 Scaffold Button", es = "🧱 Botón Scaffold", pt = "🧱 Botão Scaffold", ko = "🧱 스캐폴드 버튼", ja = "🧱 足場ボタン", uk = "🧱 Кнопка Scaffold" },
        ...
        ["Self"] = { ru = "От Себя", en = "Self", es = "Mismo", pt = "Próprio", ko = "자신", ja = "自分", uk = "Від Себе" },
        ...
        ["slider_auto_honor_delay"] = { ru = "Задержка перед хонором (сек)", en = "Honor Delay (sec)", es = "Retraso de Honor (seg)", pt = "Atraso de Honra (seg)", ko = "명예 지연 (초)", ja = "オナー遅延 (秒)", uk = "Затримка перед хонором (сек)" },
