...
Mega.Localization = {
    ...
    Strings = {
        ...
        ["button_open_kit_ban"] = { ru = "🚫 Меню Бана Китов (Ranked)", en = "🚫 Kit Ban Menu (Ranked)", es = "🚫 Menú de Ban de Kits (Ranked)", pt = "🚫 Menu de Ban de Kits (Ranked)", ko = "🚫 키트 밴 메뉴 (랭크)", ja = "🚫 キットバンメニュー (ランク)", uk = "🚫 Меню Бану Кітів (Ranked)" },
