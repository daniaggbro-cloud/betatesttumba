...
Mega.Localization = {
    ...
    Strings = {
        ...
        ["toggle_staff_detector_clans"] = { ru = "Черный список кланов", en = "Blacklist Clans", uk = "Чорний список кланів" },
        ["toggle_staff_detector_party"] = { ru = "Выходить из пати", en = "Leave Party", uk = "Виходити з паті" },
        ...
        ["textbox_staff_detector_users"] = { ru = "ЧС Игроков (ID через запятую)", en = "Blacklisted Users (IDs split by comma)", uk = "ЧС Гравців (ID через кому)" },
