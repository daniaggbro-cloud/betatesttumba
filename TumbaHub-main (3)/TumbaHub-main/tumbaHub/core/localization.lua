...
Mega.Localization = {
    ...
    Strings = {
        ...
        ["toggle_alchemist_collect"] = { ru = "Авто-сбор ингредиентов", en = "Auto Collect Ingredients", es = "Auto Recolectar Ingredientes", pt = "Auto Coletar Ingredientes", ko = "재료 자동 수집", ja = "材料自動収集", uk = "Авто-збір інгредієнтів" },
