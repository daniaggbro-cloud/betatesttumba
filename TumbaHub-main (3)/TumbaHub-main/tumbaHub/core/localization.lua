...
Mega.Localization = {
    ...
    Strings = {
        ...
        ["toggle_mobile_button"] = { ru = "📱 Показывать кнопку меню (Мобильная)", en = "📱 Show Mobile Menu Button", es = "📱 Mostrar Botón de Menú Móvil", pt = "📱 Mostrar Botão de Menu Mobile", ko = "📱 모바일 메뉴 버튼 표시", ja = "📱 모바일メニューボタンを表示", uk = "📱 Показувати мобільну кнопку меню" },
