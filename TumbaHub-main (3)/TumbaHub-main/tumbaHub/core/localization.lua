...
Mega.Localization = {
    ...
    Strings = {
        ...
        ["toggle_kit_ban"] = { ru = "🚫 Бан Китов (Ranked)", en = "🚫 Kit Ban (Ranked)", es = "🚫 Ban de Kits (Ranked)", pt = "🚫 Ban de Kits (Ranked)", ko = "🚫 키트 밴 (랭크)", ja = "🚫 キットバン (ランク)", uk = "🚫 Бан Кітів (Ranked)" },
        ["keybind_kit_ban"] = { ru = "Клавиша для бана", en = "Ban Keybind", es = "Tecla para banear", pt = "Tecla para banir", ko = "밴 단축키", ja = "バンキーバインド", uk = "Клавіша для бану" },
        ["kit_ban_target"] = { ru = "Цель: %s", en = "Target: %s", es = "Objetivo: %s", pt = "Alvo: %s", ko = "대상: %s", ja = "対象: %s", uk = "Ціль: %s" },
        ["title_kit_ban"] = { ru = "ВЫБЕРИТЕ КИТ ДЛЯ БАНА", en = "SELECT KIT TO BAN", es = "SELECCIONA EL KIT PARA BANEAR", pt = "SELECIONE O KIT PARA BANIR", ko = "밴할 키트를 선택하세요", ja = "バンするキットを選択", uk = "ОБЕРІТЬ КІТ ДЛЯ БАНУ" },
        ["search_kit_ban"] = { ru = "🔍 Поиск кита...", en = "🔍 Search kit...", es = "🔍 Buscar kit...", pt = "🔍 Buscar kit...", ko = "🔍 키트 검색...", ja = "🔍 キットを検索...", uk = "🔍 Пошук кіта..." },
        ["banning_kit"] = { ru = "БАН: ", en = "BANNING: ", es = "BANEANDO: ", pt = "BANINDO: ", ko = "밴 중: ", ja = "バン中: ", uk = "БАНУВАННЯ: " },
        ["banned_kit_success"] = { ru = "ЗАБАНЕН!", en = "BANNED!", es = "¡BANEADO!", pt = "BANIDO!", ko = "밴 성공!", ja = "バン成功!", uk = "ЗАБАНЕНИЙ!" },
        ["banned_kit_fail"] = { ru = "ОШИБКА!", en = "ERROR!", es = "¡ERROR!", pt = "ERRO!", ko = "오류!", ja = "エラー!", uk = "ПОМИЛКА!" },
