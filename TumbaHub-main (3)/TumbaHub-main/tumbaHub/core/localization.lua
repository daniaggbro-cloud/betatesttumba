...
Mega.Localization = {
    ...
    Strings = {
        ...
        ["button_streamproof_clip"] = { ru = "🎥 Записать StreamProof клип (F12)", en = "🎥 StreamProof Clip (F12)", es = "🎥 Clip StreamProof (F12)", pt = "🎥 Clipe StreamProof (F12)", ko = "🎥 스트림프루프 클립 (F12)", ja = "🎥 ストリームプルーフクリップ (F12)", uk = "🎥 Зробити StreamProof кліп (F12)" },
        ["notify_streamproof_started"] = { ru = "🎥 Запись клипа начата! Чита на видео не будет.", en = "🎥 Recording started! Cheat won't be visible.", es = "🎥 ¡Grabación iniciada! El cheat no será visible.", pt = "🎥 Gravação iniciada! Cheat não será visível.", ko = "🎥 녹화 시작! 치트가 보이지 않습니다.", ja = "🎥 録画開始！チートは表示されません。", uk = "🎥 Запис розпочато! Чіта на відео не буде." },
        ["notify_streamproof_error"] = { ru = "⚠️ Экзекутор не поддерживает симуляцию клавиш!", en = "⚠️ Your executor doesn't support keypress!", es = "⚠️ ¡Tu ejecutor no soporta keypress!", pt = "⚠️ Seu executor não suporta keypress!", ko = "⚠️ 익스큐터가 keypress를 지원하지 않습니다!", ja = "⚠️ エグゼキュータがkeypressをサポートしていません！", uk = "⚠️ Твій екзекутор не підтримує keypress!" },
