...
local getcustomassets = {
	['tumbascript/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['tumbascript/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['tumbascript/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['tumbascript/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['tumbascript/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['tumbascript/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['tumbascript/assets/old/info.png'] = 'rbxasset://info.png',
	['tumbascript/assets/old/pin.png'] = 'rbxasset://pin.png',
	['tumbascript/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['tumbascript/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['tumbascript/assets/old/search.png'] = 'rbxasset://search.png',
	['tumbascript/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['tumbascript/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['tumbascript/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['tumbascript/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['tumbascript/assets/old/texttumbahub.png'] = 'rbxasset://texttumbahub.png',
	['tumbascript/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['tumbascript/assets/old/tumbahub.png'] = 'rbxassetid://14373395239',
	['tumbascript/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('tumbascript/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('tumbascript/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('tumbascript/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('tumbascript/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('tumbascript/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('tumbascript/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('tumbascript/profiles/'..self.Profile..self.Place..'.txt') then
		local savedata = loadJson('tumbascript/profiles/'..self.Profile..self.Place..'.txt')
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('tumbascript/assets/old/tumbahub.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('tumbascript/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('tumbascript/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('tumbascript/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('tumbascript/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('tumbascript/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('tumbascript/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('tumbascript/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('tumbascript/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('tumbascript/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('tumbascript/assets/old/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('tumbascript/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
local TumbaHubLogo = Instance.new('ImageLabel')
TumbaHubLogo.Name = 'Logo'
TumbaHubLogo.Size = UDim2.fromOffset(96, 26)
TumbaHubLogo.Position = UDim2.new(1, -142, 0, 3)
TumbaHubLogo.BackgroundTransparency = 1
TumbaHubLogo.BorderSizePixel = 0
TumbaHubLogo.Visible = true
TumbaHubLogo.BackgroundColor3 = Color3.new()
TumbaHubLogo.Image = getcustomasset('tumbascript/assets/old/texttumbahub.png')
...
TumbaHubLogoV4.Size = UDim2.fromOffset(43, 30)
TumbaHubLogoV4.Position = UDim2.new(1, 1, 0, -2)
TumbaHubLogoV4.BackgroundColor3 = Color3.new()
TumbaHubLogoV4.BackgroundTransparency = 1
TumbaHubLogoV4.BorderSizePixel = 0
TumbaHubLogoV4.Image = getcustomasset('tumbascript/assets/old/textv4.png')
TumbaHubLogoV4.Parent = TumbaHubLogo
local TumbaHubLogoShadow = TumbaHubLogo:Clone()
TumbaHubLogoShadow.Position = UDim2.fromOffset(1, 1)
TumbaHubLogoShadow.ZIndex = 0
TumbaHubLogoShadow.Visible = true
TumbaHubLogoShadow.ImageColor3 = Color3.new()
TumbaHubLogoShadow.ImageTransparency = 0.65
TumbaHubLogoShadow.Parent = TumbaHubLogo
TumbaHubLogoShadow.Logo2.ZIndex = 0
TumbaHubLogoShadow.Logo2.ImageColor3 = Color3.new()
TumbaHubLogoShadow.Logo2.ImageTransparency = 0.65
...
function mainapi:UpdateTextGUI(afterload)
	...
	if textgui.Button.Enabled then
		...
		TumbaHubLogo.Position = right and UDim2.new(1 / TumbaHubTextScale.Scale, -141, 0, 4) or UDim2.fromOffset(5, 4)
		...
		TumbaHubLabelHolder.Position = UDim2.fromOffset(4, 4 + (TumbaHubLogo.Visible and TumbaHubLogo.Size.Y.Offset or 0))
...
function mainapi:UpdateGUI(hue, sat, val, default)
	...
	if textgui.Button.Enabled then
		...
		TumbaHubLogoGradient2.Color = mainapi.GUIColor.Rainbow and TumbaHubLogoGradient.Color or ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)),
			ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))
		})
		for i, v in TumbaHubLabels do
			v.Text.TextColor3 = customcolor or (mainapi.GUIColor.Rainbow and Color3.fromHSV(mainapi:Color((hue - ((i + 2) * 0.025)) % 1)) or TumbaHubLogoGradient.Color.Keypoints[2].Value)
		end
	end
