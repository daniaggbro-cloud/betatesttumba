...
run(function()
	...
	InfiniteStamina = tumbahub.Categories.Blatant:CreateModule({
...
run(function()
	...
	AutoEat = tumbahub.Categories.Utility:CreateModule({
		Name = 'AutoEat',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	AutoPickup = tumbahub.Categories.Utility:CreateModule({
		Name = 'AutoPickup',
		Function = function(callback)
			if callback then 
