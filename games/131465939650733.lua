...
tumbahub.Place = 5938036553
if isfile('tumbascript/games/'..tumbahub.Place..'.lua') then
	loadstring(readfile('tumbascript/games/'..tumbahub.Place..'.lua'), 'bedwars')()
else
	if not shared.TumbaHubDeveloper then
		...
		if suc and res ~= '404: Not Found' then
			loadstring(downloadFile('tumbascript/games/'..tumbahub.Place..'.lua'), 'bedwars')()
		end
	end
end